...
export const OUTCOMES: Outcome[] = [
...

  {
    ...
    ctaHeadline: "Talk to us about your ESOP.",
    ctaBody:
      "Enter your details and we will open the booking calendar so you can pick a time that works.",
...

  {
    ...
    leadIntent: "nurture",
    ctaSectionLabel: "RECOMMENDED NEXT STEP",
    ctaHeadline: "Download the ESOP Checklist.",
    ctaBody:
      "Enter your business email and we will send the checklist that matches your result.",
    primaryCtaLabel: "Send me the ESOP Checklist",
...

  {
    ...
    leadIntent: "cold",
    ctaSectionLabel: "RECOMMENDED NEXT STEP",
    ctaHeadline: "Download the ESOP Starter Checklist.",
    ctaBody:
      "Enter your business email and we will send the checklist that matches your result.",
    primaryCtaLabel: "Send me the ESOP Starter Checklist",
    secondaryCtaLabel: "Subscribe to valuation insights",
    ctaUrl: BOOKING_URL,
...

  {
    ...
    leadIntent: "hot",
    ctaSectionLabel: "RECOMMENDED NEXT STEP",
    ctaHeadline: "Talk to us about your business value.",
    ctaBody:
      "Enter your details and we will open the booking calendar so you can pick a time that works.",
    primaryCtaLabel: "Talk to us",
...

  {
    ...
    leadIntent: "nurture",
    ctaSectionLabel: "RECOMMENDED NEXT STEP",
    ctaHeadline: "Download the Hidden Value Checklist.",
    ctaBody:
      "Enter your business email and we will send the checklist that matches your result.",
    primaryCtaLabel: "Send me the Hidden Value Checklist",
    secondaryCtaLabel: "Subscribe to valuation insights",
    ctaUrl: BOOKING_URL,
